...
{
	return CUnit(mem.Read<std::uintptr_t>(base_address + offsets::_CPlayer::player_unit) - 1 /*magic shit*/);
}
...
void CPlayer::set_name()
{
	name =  globals::ReadString(this->base_address + offsets::_CPlayer::name,30);
}

//void CPlayer::set_team() 
//{
//	team =  mem.Read<uint8_t>(this->base_address + offsets::_CPlayer::team);
//}
//
